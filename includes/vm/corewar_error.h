...
# define FLG_B_EXISTS "ERROR. Flag [-b] already exists.\n"
# define FLG_V_EXISTS "ERROR. Flag [-v] already exists.\n"
# define FLG_N_INVAL "ERROR. Missing / invalid number of the next champion.\n"
# define FLG_V_AND_B "ERROR. Flags [-v] and [-b] can't exist together.\n"
# define FLG_DUMP_AND_P "ERROR. Flags [-dump] and [-p] can't exist together.\n"
# define FLG_V_AND_P "ERROR. Flag [-p] can't exist without flag [-v].\n"
...
# define TOO_LARGE_BOT_FILE "ERROR. The file is larger than it should be.\n"
